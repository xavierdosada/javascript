function loadTurn(event){
    ...
    if (validation == true){
        ...
        alert("La fecha y hora ya estan reservadas")
    }
}
...
function validationForm(turnObject){
    ...
    turnsArrayForValidation.forEach( element => {
        element.turnDate === turnObject.turnDate ? element.turnTime === turnObject.turnTime ? false : true : true;
    }); 
}
...
function insertRowInTurnTable(turnObject){
    ...
    //Escucha el boton "Eliminar" y elimina la fila.
